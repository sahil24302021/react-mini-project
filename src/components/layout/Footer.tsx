...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t mt-24" style={{ borderColor: 'var(--border)' }}>
      {/* Animated glow line — a gradient that changes with the current color */}
      <motion.div
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2 flex flex-col gap-5">
            ...
            {/* Live color badge — shows what's currently active */}
        ...
        >
          <p className="font-mono text-[11px] tracking-wider" style={{ color: 'var(--text-3)' }}>
            © 2025 Palette Studio. Built with React + TypeScript.
          </p>
